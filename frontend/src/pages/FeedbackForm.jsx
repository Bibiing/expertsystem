    ...
    <div className="min-h-screen bg-linear-to-br from-slate-50 to-emerald-50/30 py-6 sm:py-8 md:py-12 px-3 sm:px-4 lg:px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <section className="mb-6 sm:mb-8">
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-md border border-slate-200 p-4 sm:p-6 md:p-8">
        ...
        {/* FAQ  */}
        <section className="bg-white rounded-xl sm:rounded-2xl shadow-md border border-slate-200 p-4 sm:p-6 md:p-8">
          <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
            <div className="p-1.5 sm:p-2 bg-emerald-100 rounded-lg">
